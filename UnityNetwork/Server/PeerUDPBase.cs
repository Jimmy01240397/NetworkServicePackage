...
namespace UnityNetwork.Server
{
    public class PeerUDPBase
    {
        ...
        protected Action<ushort, string, IPEndPoint> PushPacket;
                ...
                try
                {
                    if (Key != "" && _socket != null)
                    {
                        ...
                        catch (Exception e)
                        {
                            ...
                            {
                                cantlink++;
                                _server.CatchMessage(_socket.ToString() + " " + e.Message + " from Reply cantlink:" + cantlink);
                                if (cantlink > 50)
                                {
                ...
                try
                {
                    if (Key != "" && _socket != null)
                    {
                        ...
                        catch (Exception e)
                        {
                            ...
                            {
                                cantlink++;
                                _server.CatchMessage(_socket.ToString() + " " + e.ToString() + " from Tell cantlink:" + cantlink);
                                if (cantlink > 50)
                                {
                                    _server.PushPacket((ushort)MessageIdentifiers.ID.CONNECTION_LOST, e.Message, _socket);
                                }
        ...
        public void check()
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    cantlink++;
                    _server.CatchMessage(_socket.ToString() + " " + e.Message + " cantlink:" + cantlink);
